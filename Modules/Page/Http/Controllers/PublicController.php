...
class PublicController extends BasePublicController
{
    ...
    public function __construct(PageRepository $page, Application $app, FooterRepository $footer)
    {
        parent::__construct();
        $this->page = $page;
        $this->app = $app;
    ...
    public function homepage()
    {
        ...
        $footer  = $this->footer->findFooter();

        return view($template, compact('page', 'footer'));
    }
